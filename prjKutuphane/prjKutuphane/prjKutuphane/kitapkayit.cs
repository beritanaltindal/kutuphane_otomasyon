    ...
    public partial class kitapkayit : Form
    {
        ...
        void Kayit()
        {
            if (nesne.KitapKontrol(txtKitapKod.Text) == true)
            {
                ...
                nesne.KitapKayit(txtKitapKod.Text, txtKitapAd.Text, cbKategoriAd.Text, txtYazarAd.Text, txtRafNo.Text, cbKitapDurum.SelectedText, txtAciklama.Text);
        ...
        { // Yeni Kayıt sağlar
            ...
            {
                nesne.KitapGuncelle(txtKitapKod.Text, txtKitapAd.Text, cbKategoriAd.Text, txtYazarAd.Text, txtRafNo.Text, cbKitapDurum.SelectedText, txtAciklama.Text);
